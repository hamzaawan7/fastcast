...
<div class="col-md-12">
    ...
    <div class="col-md-8">
        <div class="col-md-12" style="background-color: #fff; margin:20px 0; border-radius: 6px">
            ...
            <?php if ($user->type == "Actor" && !StringsHelper::getProjectUserRole(base64_decode($_GET['pn']), $user->id)) { ?>
                <div class="col-md-12">
            ...
            <?php } else { ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <?= $form->field($model, 'user_id')->dropDownList(DropDownHelper::getUsers(), ['prompt' => '-- select --']) ?>
                    </div>
                    <div class="col-md-3"></div>
                </div>
                <center style="margin:10px">OR</center>
                <div class="col-md-12">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
